...
const items = ref([
	...
	{ id: 4, title: 'John Doe - Boss', frequency: 1},
	{ id: 5, title: 'Peter Doe - Recruit', frequency: 1},
	{ id: 6, title: 'Cool Doe - Recruit', frequency: 1},
	{ id: 7, title: 'McDoe - Average', frequency: 2},
	{ id: 8, title: 'John Doe - Boss', frequency: 1},
	{ id: 9, title: 'Peter Doe - Recruit', frequency: 1},
	{ id: 10, title: 'Cool Doe - Recruit', frequency: 1},
	{ id: 11, title: 'McDoe - Average', frequency: 2},
])

const getFrequency = (freq) => items.value.filter((item) => item.frequency === freq)
const addItem = (title, freq) => items.value.push({ id: items.value.length, title: title, frequency: freq });
	...
	<div class="absolute h-screen w-screen flex justify-end items-center font-sans">
		<div class="w-52 md:w-60 lg:w-72 xl:w-80 mr-4 h-[50%] bg-[#7A7A7AFF] rounded-l-xl flex flex-col justify-start items-center overflow-y-auto">
			...
			<div class="bg-neutral-600 w-5/6 rounded-lg mt-2 flex flex-col justify-start items-center mb-4">
				...
				<div @drop="onDrop($event, 3)" @dragenter.prevent @dragover.prevent class="w-full h-full flex flex-col items-center justify-start mt-2 mb-2">
